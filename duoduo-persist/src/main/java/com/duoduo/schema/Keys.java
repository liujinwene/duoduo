...
public class Keys {
    ...
    public static final UniqueKey<AmountTestRecord> KEY_AMOUNT_TEST_PRIMARY = UniqueKeys0.KEY_AMOUNT_TEST_PRIMARY;
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        public static final UniqueKey<AmountTestRecord> KEY_AMOUNT_TEST_PRIMARY = createUniqueKey(AmountTest.AMOUNT_TEST, "KEY_amount_test_PRIMARY", AmountTest.AMOUNT_TEST.ID);
